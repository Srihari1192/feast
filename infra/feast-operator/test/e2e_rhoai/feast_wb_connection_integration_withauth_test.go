...
// of executing a Feast workbench integration connection with kubernetes auth successfully.
package e2erhoai
...
var _ = Describe("Feast Workbench Integration Connection Testing - With Auth", Ordered, func() {
	const (
