...
def _kube_api_error_handling(self, e):
...
def validate_feature_store_cr_status(namespace, cr_name, timeout_seconds=120, interval_seconds=5):
...
def wait_for_pods_ready(namespace, label_selector, timeout_seconds=120, interval_seconds=5):
...
def run_kubectl_apply_with_sed(aws_access_key, aws_secret_key, aws_bucket_name,aws_feast_registry_path,template_path, namespace):
    ...
    # escaped_region = shlex.quote(aws_region)
